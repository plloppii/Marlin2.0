...
#define HAS_USER_THERMISTORS ANY_TEMP_SENSOR_IS(1000)
  ...
  #define HEATER_BED_USES_MAX31856
...
#if TEMP_SENSOR_CHAMBER == -5
  #define HEATER_CHAMBER_USES_MAX31856
...
#define HAS_TEMP_BED (HAS_TEMP_ADC_BED || ENABLED(HEATER_BED_USES_MAX31856))
#define HAS_TEMP_CHAMBER (HAS_TEMP_ADC_CHAMBER || ENABLED(HEATER_CHAMBER_USES_MAX31856))
#define HAS_HEATED_CHAMBER ((HAS_TEMP_CHAMBER || ENABLED(HEATER_CHAMBER_USES_MAX31856)) && PIN_EXISTS(HEATER_CHAMBER))
